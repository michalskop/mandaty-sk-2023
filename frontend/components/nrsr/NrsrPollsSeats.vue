<template>
  <div>
    <h3>Počet mandátov <small>s odhadom chyby</small> <span class="badge">{{ date }}</span> </h3>
    <div class="container">
      <div class="row">
...
<script>
import currentSeats from '~/assets/data/nrsr/current_seats.json'

export default {
  data: function (){
    return {
      seats: currentSeats['data'],
      date: new Date(currentSeats['date']).toLocaleDateString('sk-SK')
  }
  },
  filters: {
    abs(value) {
